...
import { X, Sparkles, AlertCircle, Camera, CheckCircle2, QrCode } from 'lucide-react';
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider">
                  QR Code / Shelf Tag (Optional)
                </label>
                <button
                  type="button"
                  id="btn-scan-part-qrcode"
                  ...
                  title="Scan physical package QR code with camera"
                >
              ...
              {scannedFeedback && (
                <div className="mb-1.5 p-2 bg-emerald-50 border border-emerald-200 rounded-md text-[11px] text-emerald-800 flex items-center justify-between">
                  <div className="flex items-center gap-1.5 font-medium">
                    ...
                    <span>Scanned QR: <strong className="font-mono">{scannedFeedback}</strong></span>
                  </div>
                  <button
                    type="button"
              ...
              <input
                ...
                placeholder="e.g. 25078945610 or QR payload..."
                className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 text-sm font-mono focus:outline-hidden focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-slate-800"
              />
            </div>
